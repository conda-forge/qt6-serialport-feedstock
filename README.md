...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/qt6-serialport-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qt6-serialport-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add qt6-serialport
# for installing globally
pixi global install qt6-serialport
```
...
It is possible to list all of the versions of `qt6-serialport` available on your platform:
...
```
pixi search qt6-serialport --channel conda-forge
```
